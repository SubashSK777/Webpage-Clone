...
const GLOBAL_LINKS = [
  ...
  { iconClass: 'fa-home',      href: '/'                  },  // Home tab
  { iconClass: 'fa-pencil',    href: '/author'            },  // Author tab
  { iconClass: 'fa-comment-o', href: '/review'            },  // Review tab

  // Author sidebar links (matched by text content)
  { text: 'Manuscripts with Decisions',       href: '/author'            },  // back to author dashboard
